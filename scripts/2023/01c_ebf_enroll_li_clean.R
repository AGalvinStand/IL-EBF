...
il_fy23_enroll_li_raw <- read_excel("C:/Users/jpacas/Documents/GitHub/IL-EBF/data/raw/FY-23-Evidence-Based-Funding-Full-Calc.xlsx", sheet = 10,
                                    skip = 5, n_max = 927) 

# fix column names
il_fy23_enroll_li_raw <- il_fy23_enroll_li_raw |>
  # convert colnames to lowercase
  rename_with(tolower) 

# look at column names
names(il_fy23_enroll_li_raw)
...
colnames(il_fy23_enroll_li_raw) <- new_names
...
il_fy23_enroll_li_clean <- il_fy23_enroll_li_raw[,-c(8,14,18)]
