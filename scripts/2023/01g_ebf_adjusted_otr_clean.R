...
il_fy23_adjusted_otr_raw <- read_excel("C:/Users/jpacas/Documents/GitHub/IL-EBF/data/raw/FY-23-Evidence-Based-Funding-Full-Calc.xlsx", sheet = 15,
                                    skip = 5, n_max=851)

# fix column names
il_fy23_adjusted_otr_raw <- il_fy23_adjusted_otr_raw |>
  # convert colnames to lowercase
  rename_with(tolower) 

# look at column names
names(il_fy23_adjusted_otr_raw)
...
new_names <- c("distid",
               ...
               "ty_2020_otr",  #Not sure what TY is
               "real_eav_2020",
               "delete5",
               "exp_transpo_fy2021",
               "delete7",
               ...
               "revsurplus", #binary
               "ty_2020_adjusted_otr",
               "delete13",
               "otr_finaladjusted_2020",
               "otr_final") # final 2020 adjusted otr for use in model (per $100 of eav)"

# manually replace column names
colnames(il_fy23_adjusted_otr_raw) <- new_names

# look at column names now
names(il_fy23_adjusted_otr_raw)

# look at district names - they are imported as characters!
glimpse(il_fy23_adjusted_otr_raw)

# delete unwanted columns

il_fy23_adjusted_otr_clean <- il_fy23_adjusted_otr_raw[,-c(5,7,9,13)]
