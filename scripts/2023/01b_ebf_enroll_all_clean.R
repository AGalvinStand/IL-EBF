...
# fix column names
il_fy23_enroll_all_raw |>
  # convert colnames to lowercase
  rename_with(tolower) 

# look at column names
names(il_fy23_enroll_all_raw)
...
colnames(il_fy23_enroll_all_raw) <- new_names

# look at column names now
names(il_fy23_enroll_all_raw)

# look at district names - they are imported as characters!
glimpse(il_fy23_enroll_all_raw$distid)
...
il_fy23_enroll_all_clean <- il_fy23_enroll_all_raw[,-c(7,10,13,17,22)]

# Remove raw dataframe

rm(il_fy23_enroll_all_raw)
