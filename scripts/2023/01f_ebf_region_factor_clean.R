...
il_fy23_region_factor_raw <- read_excel("C:/Users/jpacas/Documents/GitHub/IL-EBF/data/raw/FY-23-Evidence-Based-Funding-Full-Calc.xlsx", sheet = 14,
                                    skip = 5, n_max = 927)

# fix column names
il_fy23_region_factor_raw <- il_fy23_region_factor_raw |>
  # convert colnames to lowercase
  rename_with(tolower) 

# look at column names
names(il_fy23_region_factor_raw)
...
colnames(il_fy23_region_factor_raw) <- new_names

# look at column names now
names(il_fy23_region_factor_raw)

# look at district names - they are imported as characters!
glimpse(il_fy23_region_factor_raw)

# delete unwanted columns

il_fy23_region_factor_clean <- il_fy23_region_factor_raw[,-c(12,14,16,18,20)]
