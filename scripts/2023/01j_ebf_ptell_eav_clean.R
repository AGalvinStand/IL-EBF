...
il_fy23_ptell_eav_raw <- read_excel("C:/Users/jpacas/Documents/GitHub/IL-EBF/data/raw/FY-23-Evidence-Based-Funding-Full-Calc.xlsx", sheet = 18,
                                    skip = 5, n_max=851)

# fix column names
il_fy23_ptell_eav_raw <- il_fy23_ptell_eav_raw |>
  # convert colnames to lowercase
  rename_with(tolower) 

# look at column names
names(il_fy23_ptell_eav_raw)
...
colnames(il_fy23_ptell_eav_raw) <- new_names
...
il_fy23_ptell_eav_clean <- il_fy23_ptell_eav_raw[,-c(18)]
