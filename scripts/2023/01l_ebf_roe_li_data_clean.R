...
il_fy23_roe_li_data_raw <- read_excel("C:/Users/jpacas/Documents/GitHub/IL-EBF/data/raw/FY-23-Evidence-Based-Funding-Full-Calc.xlsx", sheet = 12,
                                      skip = 5) 

# fix column names
il_fy23_roe_li_data_raw <- il_fy23_roe_li_data_raw |>
  # convert colnames to lowercase
  rename_with(tolower) 

# look at column names
names(il_fy23_roe_li_data_raw)
...
colnames(il_fy23_roe_li_data_raw) <- new_names
...
il_fy23_roe_li_data_clean <- il_fy23_roe_li_data_raw
