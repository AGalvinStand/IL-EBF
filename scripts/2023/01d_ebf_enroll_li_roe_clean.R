...
il_fy23_enroll_li_roe_raw <- read_excel("C:/Users/jpacas/Documents/GitHub/IL-EBF/data/raw/FY-23-Evidence-Based-Funding-Full-Calc.xlsx", sheet = 11,
                                        skip = 4) 

# fix column names
il_fy23_enroll_li_roe_raw <- il_fy23_enroll_li_roe_raw |>
  # convert colnames to lowercase
  rename_with(tolower) 

# look at column names
names(il_fy23_enroll_li_roe_raw)
...
colnames(il_fy23_enroll_li_roe_raw) <- new_names
...
il_fy23_enroll_li_roe_clean <- il_fy23_enroll_li_roe_raw
