...
il_fy22_additional_investments$li_intervention <- il_fy22_additional_investments$dhs_final / il_fy22_cvs_additionalinvestment_li_clean$intervention_teacher[1]
...
il_fy22_additional_investments$li_per_pupil <- il_fy22_additional_investments$dhs_final / il_fy22_cvs_additionalinvestment_li_clean$pupil_support[1]
...
il_fy22_additional_investments$li_extended <- il_fy22_additional_investments$dhs_final / il_fy22_cvs_additionalinvestment_li_clean$extended_day_teacher[1]
...
il_fy22_additional_investments$li_summer <- il_fy22_additional_investments$dhs_final / il_fy22_cvs_additionalinvestment_li_clean$summerschool_teacher[1]
...
ebf_additional_investments <- il_fy22_additional_investments[,-c(2:25,27:29)]
