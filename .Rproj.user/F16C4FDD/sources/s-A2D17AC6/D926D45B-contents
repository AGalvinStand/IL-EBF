...
#   This script will perform the core investments calculations, taking into
#   account the policy intervention of weighting for concentrated poverty.
...
ebf_core_investments <- il_fy22_enroll_li_clean |>
...
source("scripts/ebf_control_variables_clean.R") # Need to bring back in control variables because ebf_additional_investments removes those dataframes in the final clean up

ebf_core_investments <- ebf_core_investments |>
  left_join(ebf_additional_investments, by = c("distid" = "distid"))

sub_teacher_k_12 <- il_fy22_cvs_core_subsalary_clean$daily_salary[1]
sub_assistant_k_12 <- il_fy22_cvs_core_subsalary_clean$daily_salary[2]
subdays <- il_fy22_cvs_core_subsalary_clean$daily_salary[3]

ebf_core_investments <- ebf_core_investments |>
  mutate(substitute_cost =
           (((core_investment_teacher_positions + sped_assistant)*subdays)*sub_teacher_k_12)+
             ((ai_w_cp_total_fte*subdays)*sub_assistant_k_12))
...
rm(il_fy22_cvs_assumedsalary_clean,
   il_fy22_cvs_core_class_size_clean,
   il_fy22_cvs_core_investments_clean,
   il_fy22_cvs_core_subsalary_clean,
   il_fy22_cvs_perstudent_centralservices_clean,
   il_fy22_cvs_perstudent_investment_perstudent_clean,
   il_fy22_cvs_protoschool_clean,
...
ebf_core_investments <- ebf_core_investments[,-c(73:76)] |>
  rowwise() |>
...
ebf_core_investments <- ebf_core_investments[ ,-c(3:10)]
ebf_core_investments <- ebf_core_investments[ ,-c(3:10)]
ebf_core_investments <- ebf_core_investments[ ,-c(3:10)]
ebf_core_investments <- ebf_core_investments[ ,-c(3:10)]
ebf_core_investments <- ebf_core_investments[ ,-c(3:10)]
...
ebf_core_investments <- ebf_core_investments[ ,-c(3:10)]
ebf_core_investments <- ebf_core_investments[ ,-c(3:10)]
ebf_core_investments <- ebf_core_investments[,-c(3:9)]
